...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Vidyalaya ERP — College Management Portal" },
      { name: "description", content: "Modern College ERP for students and faculty: marks, attendance, timetable, fees, and notices in one secure portal." },
    ],
    links: [
